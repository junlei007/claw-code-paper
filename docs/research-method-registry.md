...
| regression / mediation / moderation | `external` / `manual` | start from [`../examples/project-skills/questionnaire-processv50-sop/`](../examples/project-skills/questionnaire-processv50-sop/), [`../examples/project-skills/questionnaire-mediation-moderation-sop/`](../examples/project-skills/questionnaire-mediation-moderation-sop/), [`../examples/external-plugins/research-processv50/`](../examples/external-plugins/research-processv50/), and [`../examples/external-plugins/research-regression/`](../examples/external-plugins/research-regression/) |
